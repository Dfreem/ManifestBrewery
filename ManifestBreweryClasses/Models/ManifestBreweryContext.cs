...
namespace ManifestBreweryClasses.Models
{
    ...
    {
        public ManifestBreweryContext()
        {
        }

        public ManifestBreweryContext(DbContextOptions<ManifestBreweryContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Account>(entity =>
            {
                ...
                entity.HasIndex(e => e.SalesEmployeeId, "sales_employee_id");
            ...
            modelBuilder.Entity<PubEmployee>(entity =>
            {
                entity.HasKey(e => e.EmployeeId)
                    .HasName("PRIMARY");

                entity.ToTable("pub_employee");

                entity.HasIndex(e => e.AppUserId, "app_user_id");

                entity.HasIndex(e => e.PubId, "pub_id");
                ...
                entity.HasOne(d => d.AppUser)
                    .WithMany(p => p.PubEmployees)
                    .HasForeignKey(d => d.AppUserId)
                    .HasConstraintName("pub_employee_ibfk_1");

                entity.HasOne(d => d.Pub)
                    .WithMany(p => p.PubEmployees)
                    .HasForeignKey(d => d.PubId)
                    .HasConstraintName("pub_employee_ibfk_2");
            });
